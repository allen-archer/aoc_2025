...
private const val INPUT_URL_TEMPLATE = "https://adventofcode.com/2025/day/{day}/input"
...
private fun getInputFromSite(day: String): String {
    ...
    connection.setRequestProperty("Cookie", readFileText("/home/allen/repos/aoc_2025/aoc/cookie"))
    connection.connect()
